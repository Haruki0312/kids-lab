...
## テーマ別検索機能
gemのransackを導入して検索機能の実装をしました。
ユーザーにわかりやすくテーマで選んでもらう形でトップページにテーマ一覧を設置しています。
ラジオボタンで選択ができ、「検索する」をクリックすると同じテーマのidを持った作品のみ表示されるようにしました。
[![Image from Gyazo](https://i.gyazo.com/b181b5d4b00f593ec45a27ea483e8047.gif)](https://gyazo.com/b181b5d4b00f593ec45a27ea483e8047)
